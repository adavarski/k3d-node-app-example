...
const product = require('./src/routes/produto');
const swaggerUi = require('swagger-ui-express');
const YAML = require('yamljs');
const swaggerDocument = YAML.load('./swagger.yaml');
const NodeHog = require('nodehog');
const config = require('./src/config/system-life');
...
var developer_db_url = 'mongodb://mongouser:apiproduto@localhost:27017/admin';
